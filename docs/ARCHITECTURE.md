...
- TURN-class relay, Panopticon-hosted needed services, oracles/validators, and crypto (or later fiat) payments — see **Steering locks**. None of those are this PR. Next after this pull slice: durable graph + TURN.
